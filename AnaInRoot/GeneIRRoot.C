...
void GeneIRRoot(){
  TFile *newfile = new TFile("Tracking.root","recreate");
  ...
  TString filename_tous="../output/TousTracking.txt";
  ...
  //-----Bremsstrahlung------
  float dN_brem,dX_brem,Z0_brem,x_brem,px_brem,y_brem,py_brem,Z_brem,dE_brem,nturn_brem;
  int Nid_brem=0;
  ...
  TString filename_brem="../output/BremTracking.txt";
  ...
  TString filename_coul="../output/CoulTracking.txt";
