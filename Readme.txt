...
v2: STCF apert, constant parameter
runTracking_STCF:利用STCF的lattice，但需要在Ana中设置截断

CompareBEPC_STCF: use to compare bkg of BEPCII and STCF, considering Apert, Constant Parameter, Twiss Parameter, Tracking(in the future)
